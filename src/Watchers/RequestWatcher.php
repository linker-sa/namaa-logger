...
use Namaa\NamaaLogger\FormatModel;
...
class RequestWatcher extends Watcher
{
    ...
    public function recordRequest(RequestHandled $event)
    {
        ...
        NamaaLogger::recordRequest(IncomingEntry::make([
    ...
    protected function headers($headers)
    {
        ...
        return $this->hideParameters(
            $headers,
            NamaaLogger::$hiddenRequestHeaders
        );
    }
    ...
    protected function payload($payload)
    {
        return $this->hideParameters(
            $payload,
            NamaaLogger::$hiddenRequestParameters
        );
    }
        ...
        if (is_string($content)) {
            if (
                ...
                return $this->contentWithinLimits($content)
                    ? $this->hideParameters(json_decode($content, true), NamaaLogger::$hiddenResponseParameters)
                    : 'Purged By Telescope';
            }
